...
<div class="container">
  ...
  <section class="text-center container">
    <div class="row py-lg-5">
      <form action="{{ route('ingredients-store', ['id' => $]) }}" method="POST">

        @foreach($bases as $base)
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="{{ $base->id }}">
        ...
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="{{ $split->id }}">
